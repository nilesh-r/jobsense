...
export default function LoginPage() {
  ...
  return (
    <div className="premium-bg min-h-screen flex items-center justify-center px-4">
      ...
      <div className="glass-strong p-10 rounded-3xl shadow-2xl w-full max-w-md backdrop-blur-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary hover:opacity-90 text-white py-3 rounded-xl font-semibold transition-all duration-300 disabled:opacity-50 shadow-lg shadow-primary/20"
          >
        ...
        <a
          ...
          className="w-full glass-strong flex items-center justify-center space-x-3 py-3 rounded-xl hover:bg-foreground/5 transition-all duration-300 border border-premium"
        >
