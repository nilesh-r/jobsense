    ...
    <div className="premium-bg min-h-screen pb-32">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="mb-6">
          <button
            onClick={() => router.back()}
            className="glass text-foreground px-6 py-2 rounded-xl hover:bg-black/5 dark:hover:bg-white/20 transition-all font-medium"
          >
            ← Back
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="space-y-6">
            ...
            <div className="premium-card spotlight-card p-8 rounded-3xl text-center">
              ...
              <div className="text-7xl font-bold gradient-text mb-4 text-primary">
                {analysis.atsScore}%
              </div>
        ...
        {analysis.suggestions && !Array.isArray(analysis.suggestions) && (
          <div className="space-y-6">
            ...
            <div className="premium-card spotlight-card p-6 rounded-3xl border border-primary/20 bg-primary/5">
              <h2 className="text-xl font-semibold mb-6 text-foreground flex items-center gap-2">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {(analysis.suggestions as any).action_plan?.map((item: string, idx: number) => (
                  <div key={idx} className="glass p-4 rounded-2xl text-muted text-sm leading-relaxed border border-primary/10">
                    {item}
                  </div>
                ))}
              </div>
            ...
            <ul className="space-y-4">
              {analysis.suggestions.map((suggestion, idx) => (
                <li key={idx} className="flex items-start glass p-4 rounded-xl">
                  ...
                  <span className="text-muted leading-relaxed">{suggestion}</span>
                </li>
              ))}
            </ul>
          </div>
